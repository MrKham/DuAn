...
return [
    ...
    */
    ...
    'subtitle' => 'Fundstart system',

    'RECAPTCHA_SITE_KEY' => env('RECAPTCHA_SITE_KEY', '6LcBuHgUAAAAAGgUJxAuhlGkOYgb1OTUTySNSOUY'),

    'RECAPTCHA_SECRET_KEY' => env('RECAPTCHA_SECRET_KEY', '6LcBuHgUAAAAAHWmJGyuiLL1EnlC_2K_RBYJ0jpa'),

    'FB_APP_ID' => env('FB_APP_ID', '186721248488669'),
    ...
    */
    ...
    'key' => env('APP_KEY', base64_decode('tUiX2uO8aFYeVvo+8E/x37nGsQf5f7nuVFKNhUoewNk=')),
    ...
    */
    ...
    'providers' => [
        ...
        LIBRESSLtd\LBMessenger\LBMessengerServiceProvider::class,
