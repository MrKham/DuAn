...
<body>
<h5>Thông báo Dự án gọi vốn thành công | Update about successful crowdfunding campaign</h5>
<div class="row">
    <div class="col-12">
...
<div class="row">
    <div class="col-12">
        <p>Cám ơn bạn đã cùng FundStart ủng hộ các dự án sáng tạo. FundStart rất vui mừng thông báo: Dự án <a style="font-weight: bold; color: red" href="{{ url('du-an/'.$user->project_url) }}">{{$user->project_name}}</a> đã gọi vốn cộng đồng thành công! Quà tặng của bạn sẽ được chủ dự án gửi đến bạn trong thời gian sớm nhất.<br/>
            <i>Thank you for your contribution to our creative projects. FundStart is proudly informing you that <a style="font-weight: bold; color: red" href="{{ url('du-an/'.$user->project_url) }}">{{$user->project_name}}</a> has been crowdfunded successfully. Your re-ward package will be sent to you soon by project owner. </i></p>
    </div>
